...
UI_TITLE = os.environ.get("UI_TITLE") or "ChatJPP"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "L'IA en toute confidentialité"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "Ce chatbot répond a vos questions !"
)
